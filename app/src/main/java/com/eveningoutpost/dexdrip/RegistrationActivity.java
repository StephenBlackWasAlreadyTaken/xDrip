    ...
    public void attemptRegistration() {
        ...
        if (TextUtils.isEmpty(password)) {
            ...
            if (TextUtils.isEmpty(passwordConfirm)) {
                mPasswordConfirmView.setError("Password Confirmation Required");
                ...
                if (password.length() < 8) {
                    ...
                    if (password.compareTo(passwordConfirm) != 0) {
                        Toast.makeText(this, passwordConfirm + " != " + password, Toast.LENGTH_LONG).show();
                        mPasswordConfirmView.setError("Password and Confirmation must match");
                        focusView = mPasswordConfirmView;
                        cancel = true;
                    }
                }
